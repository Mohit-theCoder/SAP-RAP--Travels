CLASS zcl_m_insert_class DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zcl_m_insert_class IMPLEMENTATION.


METHOD fill_master_data.
    data : lt_bp type table of zdt_m_bp,
           lt_prod type table of zdt_m_product.
   ...
   append value #(
    ...
    append value #(
     ...
     insert zdt_m_bp from table @lt_bp.
     insert zdt_m_product from table @lt_prod.
  ENDMETHOD.
  ...
  METHOD fill_transaction_data.
    data : o_rand type REF TO cl_abap_random_int,
           ...
           lv_ord_id type zats_m_dte_id,
           lt_so type table of zats_m_so_hdr,
           lt_so_i type table of zats_m_so_item.
    ...
    select * from zdt_m_bp into table @data(lt_bpa).
    select * from zdt_m_product into table @data(lt_prod).
    ...
    insert zats_m_so_hdr from table @lt_so.
    insert zats_m_so_item from table @lt_so_i.

  ENDMETHOD.

  METHOD flush.
    delete from : zdt_m_bp, zdt_m_product, zats_m_so_hdr, zats_m_so_item.
  ENDMETHOD.
